...
export default function App() {
  ...
  const testimonials = [
    ...
    { text: "פשוט מושלם! האורחים אהבו את ההזמנות הדיגיטליות ואיסוף המתנות היה נוח ומהיר. תודה רבה!", author: "משה אברהם", event: "ברית" },
...
<p className="hero-subtitle">
  הזמנות דיגיטליות מעוצבות, אישורי הגעה בזמן אמת<br />
